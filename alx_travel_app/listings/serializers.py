...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    comment = serializers.CharField()  # Explicit CharField usage
...
class ListingSerializer(serializers.ModelSerializer):
    ...
    # Example of SerializerMethodField to get review count
    review_count = serializers.SerializerMethodField()
    
    class Meta:
        model = Listing
        fields = ['listing_id', 'host', 'name', 'description', 'location', 'pricepernight', 'created_at', 'updated_at', 'reviews', 'review_count']
...
class BookingSerializer(serializers.ModelSerializer):
    ...
    # Example of SerializerMethodField to get duration
    duration_nights = serializers.SerializerMethodField()
    
    class Meta:
        model = Booking
        fields = ['booking_id', 'property', 'user', 'checkin', 'checkout', 'total_price', 'status', 'created_at', 'duration_nights']
